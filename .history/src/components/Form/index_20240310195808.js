...
export default function Form(){
    ...
    function ValidationIMC(){
        ...
        setTextButton("Calculate") //Para voltar a apresentar o texto original
    ...
    return(
        <View style={styles.formContent}>
            <View style={styles.form}>
               ...
               <TouchableOpacity style={styles.textbuttonCalculator} onPress={() => ValidationIMC()} title={textButton}>                
               </TouchableOpacity>
...
//Antes tinhamos um Button para mostrar os resultados depois, assim:
//  <Button onPress={() => ValidationIMC()} title={textButton}/>
//mas fizemos diferente e usamos o TouchOpacity