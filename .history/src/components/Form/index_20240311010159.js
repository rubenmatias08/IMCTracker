...
export default function Form(){
    ...
    const [messageIMC, setmessageIMC] = useState(""); // Mensagem que contem o resultado
    ...
    function ValidationIMC(){
        ...
        setTextButton("Calculate your IMC") //Para voltar a apresentar o texto original
        setmessageIMC("Please insert your height and weight") //Para voltar a apresentar o texto original
